...
public record BwConfig(
    ...
    public static final MapCodec<BwConfig> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            Identifier.CODEC.optionalFieldOf("dimension", Fantasy.DEFAULT_DIM_TYPE.identifier()).forGetter(BwConfig::dimension),
